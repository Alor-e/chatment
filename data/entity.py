...
import socket
import requests
from data.classes.language_processing import LanguageProcessing
...
class EntityDetector:
    ...
    @staticmethod
    async def detect_entities_with_rasa(model_path, texts, labels):
        # Load the agent
        agent = Agent.load(model_path)

        # Parse the messages
        tasks = [agent.parse_message(text) for text in texts]
